    ...
    <form class="col s12" method="post" action="">
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <input value="<%= nameValue %>" name="reg-name" id="reg-name" type="text" class="validate">
        ...
        <div class="row">
            ...
            <div class="input-field col s6 right-align">
                <button class="waves-effect waves-light btn light-green darken-1"><i class="material-icons right">how_to_reg</i>Реєстрація</button>
            </div>
        </div>
    </form>
</div>